...
public class Swordman extends Warrior  implements Shieldable {
    ...
    public Swordman(String name, int healthPoint, Weaponable sword) {
        super(name, healthPoint, sword);
    }

    public Swordman(String name, int healthPoint, Weaponable sword, Shield shield){
        this(name, healthPoint, sword);
        this.shield = shield;
    }

    public Swordman(String string, int i, Sword sword, Buckler buckler) {
    }
